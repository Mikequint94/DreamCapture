...
notes = ["Wow... I have no idea where this came from haha",
         ...
         "Note to self: remember this dream.",
         "I still don't understand this one.",
         "I think I read a book like this..."]
...
while i < dreams.length
  ...
  dreams[i].keyword_ids = keywords.sample.id
  date -= 1
  if date == 0
    date = 30
    month -= 1
